...
namespace Backend.Business.Import.ImportRequests.ImportExerciseType
{
    ...
    public class ExerciseTypeImporter
    {
        ...
        private readonly ConcurrentDictionary<string, TagGroup> _existingGroups;
        private readonly ConcurrentDictionary<string, ExerciseType> _existingTypes;
        ...
        public ExerciseTypeImporter(IApplicationDbContext context, Guid userId, IMapper mapper)
        {
            ...
            _existingTypes = new ConcurrentDictionary<string, ExerciseType>(existingTypes);
        ...
        private IEnumerable<ExerciseTypeTag> ParseExerciseTypeProperties(string importGroups, string importTags)
        {
            ...
            var resultGroups = new Dictionary<Guid, TagGroup>();
            var resultTags = new Dictionary<Guid, Tag>();
