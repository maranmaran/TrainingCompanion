...
namespace Backend.Persistance.Configurations
{
    ...
    //public class MainDashboardConfiguration : IEntityTypeConfiguration<ApplicationUser>
    //{
    //    public void Configure(EntityTypeBuilder<ApplicationUser> builder)
    //    {
    //        builder.Property(x => x.CreatedOn).HasDefaultValueSql("getutcdate()");
    ...
    //public class TrackConfiguration : IEntityTypeConfiguration<ApplicationUser>
    //{
    //    public void Configure(EntityTypeBuilder<ApplicationUser> builder)
    //    {
    //        builder.Property(x => x.CreatedOn).HasDefaultValueSql("getutcdate()");
    ...
    //public class TrackItemConfiguration : IEntityTypeConfiguration<ApplicationUser>
    //{
    //    public void Configure(EntityTypeBuilder<ApplicationUser> builder)
    //    {
    //        builder.Property(x => x.CreatedOn).HasDefaultValueSql("getutcdate()");
