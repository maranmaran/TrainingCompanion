import { createAction, props } from '@ngrx/store'; import { TrainingProgram } from 'src/server-models/entities/training-program.model'; import { Update } from '@ngrx/entity';
